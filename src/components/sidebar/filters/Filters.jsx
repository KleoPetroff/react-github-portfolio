        ...
        <div className='sort'>
          ...
          <div className="sort-group clearfix">
            <div
              ...
              className={(this.state.sortIndex === 0 ? 'active ': '') + 'sort-item first'}>Type</div>
            <div
              onClick={() => this.changeSortType(1)}
              className={(this.state.sortIndex === 1 ? 'active ': '') + 'sort-item'}>Stars</div>
            <div
              onClick={() => this.changeSortType(2)}
              className={(this.state.sortIndex === 2 ? 'active ': '') + 'sort-item last'}>Date</div>
          </div>
        </div>
        <div className='order'>
          ...
          <div className="order-group clearfix">
            <div
              ...
              className={(this.state.orderIndex === 0 ? 'active ': '') + 'order-item first'}>ASC</div>
            <div
              onClick={() => this.changeOrderBy(1)}
              className={(this.state.orderIndex === 1 ? 'active ': '') + 'order-item last'}>DESC</div>
          </div>
        </div>
      </Fragment>
    )
